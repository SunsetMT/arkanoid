...
```
cd existing_repo
git remote add origin https://git.angrybear.games/a1/arkanoid-react.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.angrybear.games/a1/arkanoid-react/-/settings/integrations)
